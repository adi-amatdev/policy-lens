---
type: Architecture
title: PolicyLens Architecture
description: Component diagram, tech stack choices, detection heuristics, and data flow for the extension.
tags: [architecture, chrome-extension, manifest-v3, design]
...
4. For each changed section, run `diffWordsWithSpace(oldText, newText)` to get the literal delta,
   ...
   [Messaging Contract](./messaging-contract.md)) asking for a plain-English explanation of user-impact.

## Related

- [Product Brief](./product-brief.md) — user flows this architecture supports
- [Data Model](./data-model.md) — schema for storage and messaging
- [Messaging Contract](./messaging-contract.md) — typed message definitions
