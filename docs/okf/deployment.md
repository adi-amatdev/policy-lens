...
description: Local demo, Chrome Web Store, Edge, Firefox, and Safari porting instructions.
tags: [deployment, chrome-web-store, edge, firefox, safari, packaging]
...
- [Setup & Scaffold](./setup-and-scaffold.md) — build prerequisites
- [Architecture](./architecture.md) — platform constraints (offscreen, MV3)
